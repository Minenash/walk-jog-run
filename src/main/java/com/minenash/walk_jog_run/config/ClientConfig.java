...
public class ClientConfig extends MidnightConfig {
    ...
    public enum IconPosition {BESIDE_HOTBAR, ABOVE_HOTBAR, CROSSHAIR, TOP_LEFT_CORNER, TOP_RIGHT_CORNER, BOTTOM_LEFT_CORNER, BOTTOM_RIGHT_CORNER }
    public enum HungerBarColorState { STAMINA_LEFT, STAMINA_DEPLETED}

    @Entry public static IconPosition iconPosition = IconPosition.BESIDE_HOTBAR;
